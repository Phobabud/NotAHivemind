...
import (
	"NotAHiveMind/internal/consensus/config"
...
//go:generate protoc -I=../../ --go_out=../../ --go_opt=module=NotAHiveMind --go-grpc_out=../../ --go-grpc_opt=module=NotAHiveMind ../../api/proto/consensus/v1/consensus.proto
...
func init() {
	...
	storage, err = filesystem.LoadStorage(nodeConfig.ConsensusLogDirectory, 10000)
	if err != nil {
