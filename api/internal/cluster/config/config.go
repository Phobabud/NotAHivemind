...
import (
	...
	"NotAHiveMind/internal/environment"
)
...
type Limits struct {
	MaxNanoCPULimit     int64 `json:"max_nano_cpu_limit"`     //Unit is in NanoCPUs, 1 CPU = 1,000,000,000 NanoCPUs
	MaxMemoryBytesLimit int64 `json:"max_memory_bytes_limit"` //Unit is in bytes
}
...
func (m *Machine) GetMachineLimits() (int64, int64) {
	return m.Limits.MaxNanoCPULimit, m.Limits.MaxMemoryBytesLimit
}
